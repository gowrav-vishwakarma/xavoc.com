<?php
class TMail_Transport_PHPMailer extends AbstractController {
    function connect(){
        $this->fid = fsockopen(
    ...
    function send($to,$from,$subject,$body,$headers="",$replyto="",$replyto_name=""){
        ...
        if($replyto=="") $replyto=$this->api->getConfig("tmail/phpmailer/reply_to");
        if($replyto_name=="") $replyto_name = $this->api->getConfig("tmail/phpmailer/reply_to_name");
